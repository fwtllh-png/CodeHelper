...
import type {
  ApprovalCard, ChatSnapshot, InputCard, MutableTurn,
} from "./model.js";
import { maxChatTurns } from "./model.js";
import { truncate } from "./helpers.js";
import { projectSnapshot } from "./snapshot.js";
import { projectTurnEvent } from "./turn-projector.js";
export type {
...
export class ChatProjector {
  ...
  #turn(id: string): MutableTurn {
    ...
    if (turn === undefined) {
      turn = {
        id, user: "", status: "running", output: "", reasoning: "",
