...
// and Run operations on a executionLifecycle do not deadlock or panic. This catches the
// bug where triple-layered locking (Engine, executionLifecycle, Kernel) could cause
