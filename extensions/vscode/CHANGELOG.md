...
- Added workspace-scoped CodeHelper Runtime lifecycle and durable ACP sessions.
- Added native selection, diagnostics, approval, and multi-file Changes flows.
- Added local multi-root workspace support.
- Added virtualized Session navigation, hidden-view rendering suspension, and
