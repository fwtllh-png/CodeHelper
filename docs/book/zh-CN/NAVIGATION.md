...
- [MCP 与 Skill Trust](./07-security-governance/06-extension-trust.md) — `security-extension-trust` — `draft` — 规划路径: `07-security-governance/06-extension-trust.md`
...
- [编写 Skill](./11-extension-ecosystem/04-skill-plugin-hook.md) — `extension-skill-plugin-hook` — `draft` — 规划路径: `11-extension-ecosystem/04-skill-plugin-hook.md`
