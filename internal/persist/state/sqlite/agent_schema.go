...
ON agent_nodes(workspace_root, parent_agent_id, status);
...
CREATE TABLE agent_messages (
    ...
    UNIQUE (workspace_root, to_agent_id, sequence)
);
CREATE INDEX agent_messages_workspace_to_delivery
ON agent_messages(workspace_root, to_agent_id, delivered_at, sequence);
