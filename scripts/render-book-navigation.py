#!/usr/bin/env python3
"""Render bilingual knowledge-book navigation from docs/book/catalog.json."""
...
LANGUAGE = {
    "en": {
        "title": "CodeHelper Agent Engineering Book: Navigation",
        "switch": "[简体中文](../zh-CN/NAVIGATION.md) | English",
        "intro": (
            "This navigation is generated from `docs/book/catalog.json`. "
            "Planned chapters are visible without empty placeholder files."
        ),
        "legend": "## Status",
        "legend_lines": [
        ...
        "path": "planned path",
        "footer": (
            "Do not edit this file directly. Change `docs/book/catalog.json` and "
            "run `python3 scripts/render-book-navigation.py`."
        ),
    },
    "zh-CN": {
        "title": "CodeHelper Agent 工程知识书籍：导航",
        "switch": "简体中文 | [English](../en/NAVIGATION.md)",
        "intro": (
...
def main() -> int:
    ...
    if stale:
        ...
        return 1
    if not args.check:
        print("rendered bilingual book navigation")
    return 0
